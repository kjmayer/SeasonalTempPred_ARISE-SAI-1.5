...
# -*- coding: utf-8 -*-
"""
Created on Tue Apr 23 09:12:22 2024
...
for m, mem in enumerate(TESTmem):
    if m == 0:
        cont_NDJFM = xr.open_dataarray(DIR_NDJFM+'accvs20leastconf_control_75S-75Nx0-360E_seeds0-2_testmem'+str(mem)+'_layers'+str(experiments['control_NDJFM']['hidden_layers'][0])+'_ADAM'+str(experiments['control_NDJFM']['LR'])+'_L2'+str(experiments['control_NDJFM']['L2'])+'_patience'+str(PATIENCE)+'_batch'+str(BATCH_SIZE)+'_mem1-10.nc')
        sai_NDJFM  = xr.open_dataarray(DIR_NDJFM+'accvs20leastconf_SAI_75S-75Nx0-360E_seeds0-2_testmem'+str(mem)+'_layers'+str(experiments['SAI_NDJFM']['hidden_layers'][0])+'_ADAM'+str(experiments['SAI_NDJFM']['LR'])+'_L2'+str(experiments['SAI_NDJFM']['L2'])+'_patience'+str(PATIENCE)+'_batch'+str(BATCH_SIZE)+'_mem1-10.nc')
        base_NDJFM = xr.open_dataarray(DIR_base_NDJFM+'accvs20leastconf_baseline_75S-75Nx0-360E_seeds0-2_testmem'+str(mem)+'_layers'+str(experiments['baseline_NDJFM']['hidden_layers'][0])+'_ADAM'+str(experiments['baseline_NDJFM']['LR'])+'_L2'+str(experiments['baseline_NDJFM']['L2'])+'_patience'+str(PATIENCE)+'_batch'+str(BATCH_SIZE)+'_mem1-10.nc')

        cont_MJJAS = xr.open_dataarray(DIR_MJJAS+'accvs20leastconf_control_MJJAS_60S-70Nx0-360E_seeds0-2_testmem'+str(mem)+'_layers'+str(experiments['control_MJJAS']['hidden_layers'][0])+'_ADAM'+str(experiments['control_MJJAS']['LR'])+'_L2'+str(experiments['control_MJJAS']['L2'])+'_patience'+str(PATIENCE)+'_batch'+str(BATCH_SIZE)+'_mem1-10.nc')
        sai_MJJAS = xr.open_dataarray(DIR_MJJAS+'accvs20leastconf_SAI_MJJAS_60S-70Nx0-360E_seeds0-2_testmem'+str(mem)+'_layers'+str(experiments['SAI_MJJAS']['hidden_layers'][0])+'_ADAM'+str(experiments['SAI_MJJAS']['LR'])+'_L2'+str(experiments['SAI_MJJAS']['L2'])+'_patience'+str(PATIENCE)+'_batch'+str(BATCH_SIZE)+'_mem1-10.nc')
        base_MJJAS = xr.open_dataarray(DIR_base_MJJAS+'accvs20leastconf_baseline_MJJAS_60S-70Nx0-360E_seeds0-2_testmem'+str(mem)+'_layers'+str(experiments['baseline_MJJAS']['hidden_layers'][0])+'_ADAM'+str(experiments['baseline_MJJAS']['LR'])+'_L2'+str(experiments['baseline_MJJAS']['L2'])+'_patience'+str(PATIENCE)+'_batch'+str(BATCH_SIZE)+'_mem1-10.nc')
        
    else:
        cont_NDJFM_temp = xr.open_dataarray(DIR_NDJFM+'accvs20leastconf_control_75S-75Nx0-360E_seeds0-2_testmem'+str(mem)+'_layers'+str(experiments['control_NDJFM']['hidden_layers'][0])+'_ADAM'+str(experiments['control_NDJFM']['LR'])+'_L2'+str(experiments['control_NDJFM']['L2'])+'_patience'+str(PATIENCE)+'_batch'+str(BATCH_SIZE)+'_mem1-10.nc')
        sai_NDJFM_temp  = xr.open_dataarray(DIR_NDJFM+'accvs20leastconf_SAI_75S-75Nx0-360E_seeds0-2_testmem'+str(mem)+'_layers'+str(experiments['SAI_NDJFM']['hidden_layers'][0])+'_ADAM'+str(experiments['SAI_NDJFM']['LR'])+'_L2'+str(experiments['SAI_NDJFM']['L2'])+'_patience'+str(PATIENCE)+'_batch'+str(BATCH_SIZE)+'_mem1-10.nc')
        base_NDJFM_temp = xr.open_dataarray(DIR_base_NDJFM+'accvs20leastconf_baseline_75S-75Nx0-360E_seeds0-2_testmem'+str(mem)+'_layers'+str(experiments['baseline_NDJFM']['hidden_layers'][0])+'_ADAM'+str(experiments['baseline_NDJFM']['LR'])+'_L2'+str(experiments['baseline_NDJFM']['L2'])+'_patience'+str(PATIENCE)+'_batch'+str(BATCH_SIZE)+'_mem1-10.nc')
        
        cont_MJJAS_temp = xr.open_dataarray(DIR_MJJAS+'accvs20leastconf_control_MJJAS_60S-70Nx0-360E_seeds0-2_testmem'+str(mem)+'_layers'+str(experiments['control_MJJAS']['hidden_layers'][0])+'_ADAM'+str(experiments['control_MJJAS']['LR'])+'_L2'+str(experiments['control_MJJAS']['L2'])+'_patience'+str(PATIENCE)+'_batch'+str(BATCH_SIZE)+'_mem1-10.nc')
        sai_MJJAS_temp = xr.open_dataarray(DIR_MJJAS+'accvs20leastconf_SAI_MJJAS_60S-70Nx0-360E_seeds0-2_testmem'+str(mem)+'_layers'+str(experiments['SAI_MJJAS']['hidden_layers'][0])+'_ADAM'+str(experiments['SAI_MJJAS']['LR'])+'_L2'+str(experiments['SAI_MJJAS']['L2'])+'_patience'+str(PATIENCE)+'_batch'+str(BATCH_SIZE)+'_mem1-10.nc')
        base_MJJAS_temp = xr.open_dataarray(DIR_base_MJJAS+'accvs20leastconf_baseline_MJJAS_60S-70Nx0-360E_seeds0-2_testmem'+str(mem)+'_layers'+str(experiments['baseline_MJJAS']['hidden_layers'][0])+'_ADAM'+str(experiments['baseline_MJJAS']['LR'])+'_L2'+str(experiments['baseline_MJJAS']['L2'])+'_patience'+str(PATIENCE)+'_batch'+str(BATCH_SIZE)+'_mem1-10.nc')
...
# confidence level: 20% least confident

# ----- NDJFM -----
cont_NDJFM_mean = cont_NDJFM.mean(['ens','seed'],skipna=True)
sai_NDJFM_mean  = sai_NDJFM.mean(['ens','seed'],skipna=True)
base_NDJFM_mean = base_NDJFM.mean(['ens','seed'],skipna=True)

base_NDJFM_std = base_NDJFM.std(['ens','seed'],skipna=True)
sai_NDJFM_std  = sai_NDJFM.std(['ens','seed'],skipna=True)
cont_NDJFM_std = cont_NDJFM.std(['ens','seed'],skipna=True)

# diff_saibase_NDJFM  = sai_NDJFM_mean - base_NDJFM_mean
# diff_contbase_NDJFM = cont_NDJFM_mean - base_NDJFM_mean

# ----- MJJAS -----
cont_MJJAS_mean = cont_MJJAS.mean(['ens','seed'],skipna=True)
sai_MJJAS_mean  = sai_MJJAS.mean(['ens','seed'],skipna=True)
base_MJJAS_mean = base_MJJAS.mean(['ens','seed'],skipna=True)

base_MJJAS_std = base_MJJAS.std(['ens','seed'],skipna=True)
sai_MJJAS_std  = sai_MJJAS.std(['ens','seed'],skipna=True)
cont_MJJAS_std = cont_MJJAS.std(['ens','seed'],skipna=True)
...
ax['A'].text(x=-180,y=150,s='Least Confident Prediction Accuracy',fontsize=75,color='dimgrey')
...
# plt.show()
plt.savefig(DIR_FIG+'NNleastconfacc_signtest_wilks_borealsummer.png',bbox_inches='tight',dpi=300)
...
# plt.show()
plt.savefig(DIR_FIG+'NNleastconfacc_signtest_wilks_borealwinter.png',bbox_inches='tight',dpi=300)
